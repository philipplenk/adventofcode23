...
dig_instruction reinterpret(dig_instruction d)
{
	switch(d.color%16)
	{
		case 0: d.dir = direction::right; break;
		case 1: d.dir = direction::down; break;
		case 2: d.dir = direction::left; break;
		case 3: d.dir = direction::up; break;
		default: break;
	}
	d.depth = d.color/16;
